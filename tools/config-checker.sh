...
config="CONFIG_PREEMPT_RT_FULL" ; config_enable
...
#
config="CONFIG_SND_SUN4I_CODEC" ; config_disable
config="CONFIG_SND_SOC_I2C_AND_SPI" ; config_disable
...
config="CONFIG_USB_CHIPIDEA_OF" ; config_disable
...
config="CONFIG_PHY_SAMSUNG_USB2" ; config_disable
